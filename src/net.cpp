...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TravisCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are traviscoin dns seeds.
static const char *strDNSSeed[][2] = {
    {"dnsseed.traviscoin.com", "dnsseed.traviscoin.com"},
    {"dnsseed.traviscoinfoundation.org", "dnsseed.traviscoinfoundation.org"},
    {"dnsseed.xpydev.org", "dnsseed.xpydev.org"},
    {"tseed.traviscoin.com", "tseed.traviscoin.com"},
    {"testnet-seed.traviscoin.mitchellcash.com", "testnet-seed.traviscoin.mitchellcash.com"} // Mitchell Cash
};
...
unsigned int pnSeed[] =
{
    // Hard Code DNS Seed IPS for TravisCoin, traviscoinfoundation, xpydev
...
// traviscoin: stake minter thread
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TravisCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    // traviscoin: mint proof-of-stake blocks in the background
